...
export function markAsRead(id) {
  return request({ url: `/api/message/read/${id}`, method: 'put' })
}

/** 当前用户全部消息标记已读 */
export function markAllAsRead() {
  return request({ url: '/api/message/read-all', method: 'put' })
}
...
export function getLatestMessages(limit = 5) {
  return request({ url: '/api/message/latest', method: 'get', params: { limit } })
}
